...
QT_MOC_LITERAL(1, 47, 25), // "slotIncludeFilesInProject"
QT_MOC_LITERAL(2, 73, 0), // ""
QT_MOC_LITERAL(3, 74, 19), // "QVector<ClassItem*>"
QT_MOC_LITERAL(4, 94, 10) // "classImets"

    },
    "ClassGenerator::Internal::ClassGeneratorPlugin\0"
    "slotIncludeFilesInProject\0\0"
    "QVector<ClassItem*>\0classImets"
};
...
void ClassGenerator::Internal::ClassGeneratorPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ClassGeneratorPlugin *_t = static_cast<ClassGeneratorPlugin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotIncludeFilesInProject((*reinterpret_cast< const QVector<ClassItem*>(*)>(_a[1]))); break;
        default: ;
        }
