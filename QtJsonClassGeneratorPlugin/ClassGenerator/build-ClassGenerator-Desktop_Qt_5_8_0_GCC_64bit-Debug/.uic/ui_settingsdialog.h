...
public:
    ...
    QCheckBox *checkBoxIncludeInCurProj;
    QWidget *Uncrustify;
    ...
    void setupUi(QDialog *SettingsDialog)
    {
        ...
        checkBoxIncludeInCurProj = new QCheckBox(General);
        checkBoxIncludeInCurProj->setObjectName(QStringLiteral("checkBoxIncludeInCurProj"));

        formLayout->setWidget(1, QFormLayout::LabelRole, checkBoxIncludeInCurProj);
    ...
    void retranslateUi(QDialog *SettingsDialog)
    {
        ...
        checkBoxIncludeInCurProj->setText(QApplication::translate("SettingsDialog", "Include hierarchy files in current project", Q_NULLPTR));
